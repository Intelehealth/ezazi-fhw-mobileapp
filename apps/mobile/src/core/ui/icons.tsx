...
export const iconPaths = {
  ...
  // Thin back chevron (‹) — Forgot Password header's outlined back button (Figma)
  ...
  // Location pin — Setup screen's location field.
  // Figma export: Ezazi Developer File / Text Input / Outline / Map & Location / Map Point.svg
  locationPin: {
    fillRule: 'evenodd',
  ...
  // Username field.
  // Figma export: Ezazi Developer File (3) / Outline / Users / User Rounded.svg (2 subpaths: head + shoulders)
  person: {
    fillRule: 'evenodd',
    d:
  ...
  // Password field.
  // Figma export: Ezazi Developer File (2) / Outline / Security / Key Minimalistic.svg
  lock: {
    fillRule: 'evenodd',
  ...
  // Forgot-password header badge (shield + keyhole).
  // PLACEHOLDER — hand-authored, no Figma export provided yet. Swap the `d`
  // below for the real "Ezazi Developer File / Shield" SVG export once available;
  // nothing else about this icon (name, usage) needs to change.
  shieldLock: {
    fillRule: 'evenodd',
...
export const AppIcon: React.FC<AppIconProps> = ({ name, color, size = 24 }) => {
  ...
  const fillRule = typeof def === 'string' ? undefined : def.fillRule;

  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d={d} fill={color} fillRule={fillRule} />
    </Svg>
  );
};
